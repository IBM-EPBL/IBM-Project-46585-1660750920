...
app.secret_key='a'
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=6667d8e9-9d4d-4ccb-ba32-21da3bb5aafc.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=30376;Security=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=qrk32788;PWD=WbDRO7ez2reEu40k;",'','')
...
def register():
    ...
    if request.method == 'POST':
        ...
        if account:
            ...
            prep_stmt = ibm_db.prepare(conn,'INSERT INTO userss(firstname, lastname, username, email, password, address) VALUES(?, ?, ?, ?, ?, ?)')
